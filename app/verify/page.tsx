  ...
  return (
    <div className="container">
      <section>
        ...
        <p className="mb-4">
          В движении принята презумпция добросовестности. Однако сложно знать всех хорошо и
          желательно лично. Кроме того, движение начало пополняться большим количеством удалённых
          участников. Это причины, из-за которых было решено ввести процедуру верификации и
          фиксировать её двумя токенами участия MTLAP.
        </p>
        ...
        <p className="mb-4">
          Фонд предоставляет услуги верификации только удалённым участникам. Мы собираем документы,
          верифицируем видео-звонком и надежно храним несколько копий, зашифрованных GPG-ключом.
          Будучи удалённым участником, для получения статуса верифицированного, вам необходима
        ...
        <p className="mb-4">
          Напишите с просьбой о верификации на <AppLinks.Email address="stas@panarchy.now" /> или в{" "}
          <AppLinks.Telegram />. В течение суток в рабочие дни с вами свяжутся для прохождения
          следующих шагов.
        </p>
        ...
        <ul className="list-disc pl-8 mb-6 space-y-2">
          <li>
            любые два или больше документа: загранпаспорт, внутренний паспорт, ВНЖ, водительские
            права и подобное. Рекомендуется все данные перед отправкой шифровать нашим{" "}
            <AppLinks.PublicKey />
          </li>
          <li>любые два контакта: почта, номер телефона, телеграм-аккаунт;</li>
          <li>
            публичный адрес на блокчейне Stellar. Согласно внутренним соглашениям Ассоциации, эта
            связка будет публичной;
          </li>
          <li>дополнительные контакты для связи, если с вами что-либо случится (по желанию).</li>
        </ul>

        <p className="mb-4">
          Если мы с вами не знакомы, понадобится видео-звонок, чтобы с вами лично познакомиться и
          верифицировать один из ваших документов.
        </p>
        ...
        <p className="mb-4">
          Наш приоритет — это безопасность. Всегда есть вариант общаться только через почту и
          шифровать сообщения GPG. Все данные будут так же зашифрованы. Ключ расшифровки хранится на
          YubiKey отдельно от места хранения.
        </p>
